...
constexpr float POPULATIONNEWHOUSEBREAKPOINT = 10.f;
constexpr float BASEPOPULATIONGROWTHMODIFIER = 1.f;
constexpr float POPULATIONINFLUENCEGENERATION = 0.1f;
constexpr int PLAYERMARKETINDEX = 0;
constexpr float POPULATIONGROWTHDECREASEMODIFIER = 0.9;
